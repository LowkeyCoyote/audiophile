...
const Footer = () => {
  return (
    <footer className="bg-[#101010] px-40 pt-20 pb-12  text-white md:px-10 md:mb-16 sm:pt-14 sm:pb-10 sm:px-6 ">
      ...
      <div className="flex justify-between flex-wrap sm:text-center ">
        <p className="opacity-50 w-[50%] md:order-1 md:w-full   ">
        ...
        <ul
          className="flex w-[50%] mr-0 gap-4 self-end justify-end
        sm:self-center fill-dark-peach md:order-3 sm:w-full sm:justify-center"
        >
          <li>
            <Link to="./">
              <svg
        ...
        <div className="pt-14 md:order-2 md:w-[50%] sm:w-full sm:mb-12 ">
