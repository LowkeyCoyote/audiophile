  ...
  return (
    <div className={twMerge(`flex items-center justify-between md:flex-col-reverse`, className)}>
      ...
      <img
        ...
        src={!isMobile && isTablet ? bestGearTablet : isMobile ? bestGearMobile : bestGearDesktop}
        alt={!isMobile && isTablet ? 'best gear  tablet' : isMobile ? 'best gear mobile' : 'best gear desktop'}
      />
    </div>
  );
};
