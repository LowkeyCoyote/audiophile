...
const HeroHome = () => {
  return (
    <div
      className="bg-hero-home-desktop bg-no-repeat  bg-[right_bottom_1rem] bg-[#191919] px-40 pt-32 pb-36 text-white 
    ...
    >
      <div className="md:text-center">
        ...
        <h1 className="text-white mb-6 w-1/3 md:w-full sm:text-[40px] sm:leading-8">
